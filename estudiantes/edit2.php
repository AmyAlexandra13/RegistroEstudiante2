...
if (isset($_POST["estudianteId"]) && isset($_POST["EstudianteName"]) && isset($_POST["EstudianteApellido"]) && isset($_POST["EstudianteCarrera"]) && isset($_POST["EstudianteMateria"]) && isset($_POST["profilePhoto"])  ) {

    $status = ($_POST["Status"] == "activo") ? true : false;

    $estudiante = new Estudiante($_POST["estudianteId"], $_POST["EstudianteName"], $_POST["EstudianteApellido"], $_POST["EstudianteCarrera"], $_POST["EstudianteMateria"], $_POST["Estado"]);
...
<body>
    ...
    <?php else : ?>
        ...
        <form enctype="mulitpart/form-data" action="edit2.php" method="POST">
